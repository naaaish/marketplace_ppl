        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                @else
                    ...
                    <div class="flex items-center gap-3">
                        <a href="#" class="px-4 py-2 text-white hover:text-blue-200 transition">
                            Masuk
                        </a>
                        <a href="#" class="px-6 py-2 bg-white text-blue-700 rounded-lg font-semibold hover:bg-blue-50 transition">
                            Daftar
                        </a>
                    </div>
                @endauth
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="productsGrid">
            ...
            <div class="product-card bg-white rounded-xl shadow-sm hover:shadow-xl transition duration-300 overflow-hidden group" data-category="{{ $product['category'] }}" data-name="{{ strtolower($product['name']) }}">
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 h-48 flex items-center justify-center text-7xl group-hover:scale-105 transition duration-300">
                    {{ $product['image'] }}
                </div>
